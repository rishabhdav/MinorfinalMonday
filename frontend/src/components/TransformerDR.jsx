...
function TransformerDR() {
  ...
  const detectDisease = async () => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:8080/api/transformer-dr', {
        method: 'POST',
        body: formData,
      });
      ...
      <div className="max-w-6xl mx-auto py-12 px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Advanced transformer architecture for cutting-edge diabetic retinopathy detection with attention mechanisms
          </p>
          <div className="flex justify-center items-center space-x-6 mt-6">
            <div className="flex items-center space-x-2 bg-indigo-100 dark:bg-indigo-900/30 px-4 py-2 rounded-full">
              ...
              <span className="text-sm font-medium text-indigo-800 dark:text-indigo-200">Transformer Tech</span>
            </div>
            <div className="flex items-center space-x-2 bg-purple-100 dark:bg-purple-900/30 px-4 py-2 rounded-full">
              <span className="text-purple-600 dark:text-purple-400">🎯</span>
              <span className="text-sm font-medium text-purple-800 dark:text-purple-200">High Precision</span>
            </div>
            <div className="flex items-center space-x-2 bg-violet-100 dark:bg-violet-900/30 px-4 py-2 rounded-full">
              <span className="text-violet-600 dark:text-violet-400">🧠</span>
              <span className="text-sm font-medium text-violet-800 dark:text-violet-200">Attention Model</span>
            </div>
          </div>
        </div>
          ...
          <div className="mb-8">
            ...
            >
              ...
              <div className="space-y-4">
                <div className="w-16 h-16 mx-auto bg-gradient-to-r from-purple-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    or <span className="text-purple-600 dark:text-purple-400 font-medium">browse files</span> to upload
                  </p>
                </div>
        ...
        {result && (
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 border border-gray-100 dark:border-gray-700">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-300">Transformer DR analysis complete</p>
            </div>
